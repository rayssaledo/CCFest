...
public class Application extends Controller {
	...
	private static final int DATA_SETE = 7, DATA_TRES = 3, DATA_UM = 1, DATA_DOZE = 12, DATA_DEZESSETE = 17, DATA_CINCO = 5, DATA_VINTE_UM = 21, DATA_QUINZE = 15, DATA_OITO = 8, TRES = 3;
